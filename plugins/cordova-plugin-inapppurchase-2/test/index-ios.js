...
describe('iOS purchases', () => {
  ...
  describe('#getProducts()', () => {
    ...
    it('should return an array of objects', async (done) => {
      try {
        const products = [
          { productId: 'com.test.prod1', title: 'prod1 title', description: 'prod1 description', price: '$0.99', currency: 'USD', country: 'US', priceRaw: '0.99', introductoryPrice: null, introductoryPriceSupported: false, priceAsDecimal: 0.99 },
          { productId: 'com.test.prod2', title: 'prod2 title', description: 'prod2 description', price: '$1.99', currency: 'USD', country: 'US', priceRaw: '0.99', introductoryPriceSupported: true, priceAsDecimal: 1.99,
              introductoryPrice: { price: '$0.99', priceRaw: '0.99', country: 'US', currency: 'USD', paymentMode: 'PayAsYouGo', numberOfPeriods: '1', subscriptionPeriod: { unit: 'month', numberOfUnits: '1', } } }
        ];
