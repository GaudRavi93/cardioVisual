...
var VideoDetailsPage = /** @class */ (function () {
    ...
    VideoDetailsPage.prototype.ionViewDidLoad = function () {
        return __awaiter(this, void 0, void 0, function () {
            var category_id, that, condition_data, treatment_data, device_data, tag_query, query, query_2, playlistData1, videoDetail_launch, that, frmbranch, playName, brancharr, brnchlen, i, shiftedObject, subtopics_id, arr, shiftedObject, videoDetailLaunch1;
            var _this = this;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (that.playlistindex > -1) {
                            shiftedObject = brancharr.splice(that.playlistindex, 1)[0];
                    ...
                    case 3:
                        ...
                        // Move the object to the beginning of the array
                        if (that.playlistindex > -1) {
                            shiftedObject = arr.splice(that.playlistindex, 1)[0];
