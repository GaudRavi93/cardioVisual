...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__channels__ = __webpack_require__(787);
...
var ChannelsPageModule = /** @class */ (function () {
    ...
    ChannelsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__channels__["a" /* ChannelsPage */]),
...
var ChannelsPage = /** @class */ (function () {
    function ChannelsPage(navCtrl, injector) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.injector = injector;
        this.http_service_object = injector.get(__WEBPACK_IMPORTED_MODULE_3__services_HttpService__["a" /* HttpService */]);
        this.database_provider_object = injector.get(__WEBPACK_IMPORTED_MODULE_4__providers_database_database__["a" /* DatabaseProvider */]);
        ...
        this.database_provider_object.fetchAllData('channels', channel_query)
            .then(function (channel_result) {
            _this.channelsDatashown = channel_result;
            console.log(_this.channelsDatashown, 'this.channelsDatashown');
            var channelToRemove = 'Heart Rhythm Society 2019';
            var channelIdx = _this.channelsDatashown.findIndex(function (val) { return val.name === channelToRemove; });
            if (channelIdx !== -1) {
                _this.channelsDatashown.splice(channelIdx, 1);
            }
        })
    ...
    ChannelsPage.prototype.getChannelClick = function (chnnltopic) {
    ...
    ChannelsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-channels',template:/*ion-inline-start:"C:\Users\pc\Downloads\cardioVisual\src\pages\channels\channels.html"*/'<!--\n\n  Generated template for the ChannelsPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header clean-header  class="headerColor"></ion-header>\n\n\n\n\n\n\n\n<ion-content style="background-color: #ffffff;">\n\n	<ion-grid>\n\n\n\n    	<ion-item transparent no-lines style="">\n\n          <div class="channels_ion_item"  style="">Channels</div>\n\n        </ion-item>\n\n		\n\n	   <ion-row no-padding no-margin>\n\n		    <ion-col class="channel_col" col-4 (tap)="getChannelClick(chnnltopic)" *ngFor="let chnnltopic of channelsDatashown">\n\n			     <div class="channel_div">\n\n			  		 <img class="channel_img" [src]="chnnltopic.logo" />\n\n			  		<!-- <img class="channel_img" src="{{path}}channels/{{chnnltopic.logo_filename}}" /> -->\n\n					<p class="channel_name" no-margin no-padding>{{chnnltopic.name}}</p>\n\n				 </div>\n\n			</ion-col>\n\n		</ion-row>\n\n	</ion-grid>\n\n</ion-content>\n\n\n\n<!-- <ion-content style="background-color: #ffffff;">\n\n	<ion-grid>\n\n    	<ion-item transparent no-lines style="">\n\n          <div class="channels_ion_item"  style="">Channels</div>\n\n        </ion-item>		\n\n	   <ion-row no-padding no-margin>\n\n		    <ion-col class="channel_col" col-4 (tap)="getChannelClick(chnnltopic)" *ngFor="let chnnltopic of channels_data">\n\n			    <div class="channel_div">\n\n				  	<img class="channel_img" src="{{path}}channels/{{chnnltopic.logo_filename}}" />\n\n				  	\n\n					<p class="channel_name" no-margin no-padding>{{chnnltopic.name}}</p>\n\n				</div>\n\n			</ion-col>\n\n		</ion-row>\n\n	</ion-grid>\n\n</ion-content> -->\n\n\n\n<ion-footer clean-footer style="background-color: #F0F0F0 !important;" [activeFootermenu]="false" [ismyCv]="false" [ismyChannel]="true"></ion-footer>\n\n'/*ion-inline-end:"C:\Users\pc\Downloads\cardioVisual\src\pages\channels\channels.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavController */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Injector */]])
    ], ChannelsPage);
    return ChannelsPage;
