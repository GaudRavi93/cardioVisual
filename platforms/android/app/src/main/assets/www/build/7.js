...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dashboard__ = __webpack_require__(790);
...
var DashboardPageModule = /** @class */ (function () {
    ...
    DashboardPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__dashboard__["a" /* DashboardPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_HttpService__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_database_database__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_clevertap__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_screen_orientation__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_network_check_network_check__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_app_rate__ = __webpack_require__(320);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardPage = /** @class */ (function () {
    function DashboardPage(navCtrl, injector) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.injector = injector;
        this.online = true;
        ...
        this.database_provider_object = injector.get(__WEBPACK_IMPORTED_MODULE_3__providers_database_database__["a" /* DatabaseProvider */]);
        this.platform_object = injector.get(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* Platform */]);
        this.clevertap_object = new __WEBPACK_IMPORTED_MODULE_4__ionic_native_clevertap__["a" /* CleverTap */]();
        this.screen_orientation_object = injector.get(__WEBPACK_IMPORTED_MODULE_5__ionic_native_screen_orientation__["a" /* ScreenOrientation */]);
        this.toast_controller_object = injector.get(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["x" /* ToastController */]);
        ...
        this.app_rate_object = injector.get(__WEBPACK_IMPORTED_MODULE_7__ionic_native_app_rate__["a" /* AppRate */]);
        this.platform_object.ready().then(function () {
            _this.network_type = _this.network_check_object.getNetworkType();
            if (_this.network_type != 'none') {
                setTimeout(function () {
                    _this.network_check_object.getPageAction('DashboardPage', 'start', '', localStorage.getItem('cv5usrType'));
                }, 1000);
                setTimeout(function () {
            ...
            _this.app_rate_object.preferences = {
                usesUntilPrompt: 5,
            ...
            _this.app_rate_object.promptForRating(false);
    ...
    DashboardPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.database_provider_object.dashboardSubTopicsAPIData(localStorage.getItem("cv5usrType"));
        var topicData = new Array("");
        this.database_provider_object.fetchAllData('new_topics', topicData).then(function (data) {
            _this.params = data;
        });
    ...
    DashboardPage.prototype.getTopicClick = function (topic) {
    ...
    DashboardPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-dashboard',template:/*ion-inline-start:"C:\Users\pc\Downloads\cardioVisual\src\pages\dashboard\dashboard.html"*/'\n\n<ion-header clean-header  class="dashboard" style=""></ion-header>\n\n <!--Content-->\n\n\n\n<!-- <ion-content [ngStyle]="banner_css" scroll="false" no-padding no-margin style="top: 0;"> -->\n\n<ion-content  no-padding no-margin scroll="false">\n\n\n\n\n\n	<!--\n\n		User Dashboard Grid Layout\n\n	-->\n\n\n\n	<div class="dashboard-cont">\n\n    <ng-container *ngIf=\'params\' no-padding no-margin>\n\n      <!-- <div tappable class="dashboard-tile buttontransition" [ngStyle]="{backgroundColor:topic.hexcodeBase}" (click)="getTopicClick(topic)" *ngFor="let topic of params"> -->\n\n      <div tappable class="dashboard-tile" [ngStyle]="{backgroundColor:topic.hexcodeBase}" (click)="getTopicClick(topic)" *ngFor="let topic of params">\n\n          <div class="img-div home-logo">\n\n            <i class="logo-design" [ngClass]="topic.iconName"></i>\n\n            <p style="margin-top: 5px;">\n\n              <i class="icon-shadow" [ngStyle]="{color:topic.hexcodeContrast}" style="position: relative; top: 5px; right: 30px;"></i>\n\n            </p>\n\n          </div>\n\n\n\n          <div class="row-label" [ngStyle]="{backgroundColor:topic.hexcodeContrast}">\n\n            <b style="font-size:16px;">{{topic.name}}</b>\n\n            <!-- <b *ngIf="topic.name != \'Heart Health & Diabetes\'">{{topic.name}}</b>\n\n           <b *ngIf="topic.name == \'Heart Health & Diabetes\'" style="font-size:16px;">{{topic.name}}</b> -->\n\n          </div>\n\n      </div>     \n\n    </ng-container>\n\n\n\n    <ng-container *ngIf=\'!params\'>\n\n      <div class="dashboard-tile" *ngFor="let i of [0,1,2,3,4,5]" style="padding-left:2px;">\n\n        <div style="padding-top: 3%;" class="avatarfortab">\n\n          <ion-avatar item-start>\n\n            <skeleton-item height="150px" width="95%" class="fortab"></skeleton-item>\n\n          </ion-avatar>\n\n        </div>\n\n        <div style="position: absolute; bottom: 0; width: 100%;" class="divskelfortab">\n\n          <skeleton-item height="25px" width="95%" class="skelfortab"></skeleton-item>\n\n        </div>\n\n      </div>     \n\n    </ng-container>\n\n	</div>\n\n</ion-content>\n\n\n\n\n\n<ion-footer clean-footer style="background-color: #F0F0F0 !important;" [activeFootermenu]="true" [ismyCv]="false" [ismyChannel]="false"></ion-footer>\n\n'/*ion-inline-end:"C:\Users\pc\Downloads\cardioVisual\src\pages\dashboard\dashboard.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavController */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Injector */]])
    ], DashboardPage);
