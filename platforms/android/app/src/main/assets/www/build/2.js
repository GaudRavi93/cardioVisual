...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChannelListTabsPageModule", function() { return ChannelListTabsPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__channel_list_tabs__ = __webpack_require__(789);
...
var ChannelListTabsPageModule = /** @class */ (function () {
    function ChannelListTabsPageModule() {
    }
    ChannelListTabsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__channel_list_tabs__["a" /* ChannelListTabsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__channel_list_tabs__["a" /* ChannelListTabsPage */]),
    ...
    ], ChannelListTabsPageModule);
    return ChannelListTabsPageModule;
}());

//# sourceMappingURL=channel-list-tabs.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ChannelListTabsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_in_app_browser__ = __webpack_require__(81);
 ...
 * Ionic pages and navigation.
 */
var ChannelListTabsPage = /** @class */ (function () {
    function ChannelListTabsPage(navCtrl, injector) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.injector = injector;
        this.events = {};
        ...
        this.nav_params_object = injector.get(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavParams */]);
        this.http_object = injector.get(__WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* Http */]);
        ...
        this.storage_object = injector.get(__WEBPACK_IMPORTED_MODULE_12__ionic_storage__["b" /* Storage */]);
        ...
        this.in_app_browser_object = new __WEBPACK_IMPORTED_MODULE_6__ionic_native_in_app_browser__["a" /* InAppBrowser */]();
        ...
        var topic_querystring = new Array("");
        ...
        var category_querystring = new Array("");
        ...
        this.events = {
            'onItemClick': function (item) {
                var category = __WEBPACK_IMPORTED_MODULE_4_underscore_underscore__["where"](that.category_data, { id: item.categoryId });
                var topic = __WEBPACK_IMPORTED_MODULE_4_underscore_underscore__["where"](that.topic_data, { id: item.topicId });
                var topic_name = '';
                var category_name = '';
                if (topic.length > 0) {
    ...
    ChannelListTabsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        console.log('ionViewDidLoad ChannelListTabsPage');
        setTimeout(function () {
            var querystring = new Array(" WHERE name='" + _this.chnnl_Name + "' AND type='channel'");
            _this.database_provider_object.fetchAllData('custom_listing', querystring).then(function (custom_listing_data) {
                ...
                console.log('this.shownContent --->' + JSON.stringify(_this.shownContent));
                var that = _this;
                var custom_data = [];
                __WEBPACK_IMPORTED_MODULE_4_underscore_underscore__["each"](json_variable, function (value, index) {
                    console.log('value --->' + JSON.stringify(value));
                    var json_query = new Array("join information_data on information.id = information_data.id where information.id = " + value + " AND isActive = 1 AND information.subTopicType='" + that.shownContent + "'");
                ...
                setTimeout(function () {
                    _this.channelsListDatashown = custom_data;
                }, 200);
            });
        }, 200);
    };
    ChannelListTabsPage.prototype.comingsoon = function () {
        this.toast_controller_object.create({
            message: 'Coming Soon',
            position: 'middle',
            duration: 1000
    ...
    ChannelListTabsPage.prototype.onEvent = function (event, item, e) {
        if (e) {
            e.stopPropagation();
        }
    ...
    ChannelListTabsPage.prototype.isDownloadVideoMultiple = function () {
        var _this = this;
        this.platform_object.ready().then(function () {
    ...
    ChannelListTabsPage.prototype.downloadfile = function (url, name, id) {
        var _this = this;
    ...
    ChannelListTabsPage.prototype.downloadapi = function (groupid, userid) {
    ...
    ChannelListTabsPage.prototype.markasFavorite = function (group) {
        var _this = this;
        this.platform_object.ready().then(function () {
            var network_type = _this.network_check_object.getNetworkType();
            if (network_type == 'none') {
